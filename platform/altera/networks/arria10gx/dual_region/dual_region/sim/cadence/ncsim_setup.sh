...
mkdir -p ./libraries/dual_region_altclkctrl_181/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altclkctrl_181/sim/dual_region_altclkctrl_181_cf6o3fq.vhd" -work dual_region_altclkctrl_181 -cdslib ./cds_libs/dual_region_altclkctrl_181.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dual_region.vhd"                                                                                                                                    
fi
