...
# ----------------------------------------
# If dual_region is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 linux 2019.02.13.11:03:15
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "dual_region"
}
...
ensure_lib                            ./libraries/dual_region_altclkctrl_181/
vmap       dual_region_altclkctrl_181 ./libraries/dual_region_altclkctrl_181/
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altclkctrl_181/sim/dual_region_altclkctrl_181_cf6o3fq.vhd" -work dual_region_altclkctrl_181
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dual_region.vhd"                                                                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L dual_region_altclkctrl_181 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L dual_region_altclkctrl_181 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
