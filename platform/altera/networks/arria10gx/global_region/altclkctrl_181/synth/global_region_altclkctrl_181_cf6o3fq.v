...
module  global_region_altclkctrl_181_cf6o3fq_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //global_region_altclkctrl_181_cf6o3fq_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  global_region_altclkctrl_181_cf6o3fq  (
    inclk,
    outclk);
    ...
    global_region_altclkctrl_181_cf6o3fq_sub  global_region_altclkctrl_181_cf6o3fq_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
