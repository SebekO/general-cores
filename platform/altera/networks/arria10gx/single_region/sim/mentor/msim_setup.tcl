...
# ----------------------------------------
# If single_region is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 linux 2019.02.13.11:03:42
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "single_region"
}
...
ensure_lib                              ./libraries/single_region_altclkctrl_181/
vmap       single_region_altclkctrl_181 ./libraries/single_region_altclkctrl_181/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altclkctrl_181/sim/single_region_altclkctrl_181_bjorw2i.v" -work single_region_altclkctrl_181
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/single_region.v"                                                                                
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L single_region_altclkctrl_181 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L single_region_altclkctrl_181 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
