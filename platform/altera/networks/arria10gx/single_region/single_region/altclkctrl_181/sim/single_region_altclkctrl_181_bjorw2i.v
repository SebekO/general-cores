//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="Regional Clock" DEVICE_FAMILY="Arria 10" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="OFF" ena inclk outclk
...
module  single_region_altclkctrl_181_bjorw2i_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //single_region_altclkctrl_181_bjorw2i_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  single_region_altclkctrl_181_bjorw2i  (
    inclk,
    outclk);
    ...
    single_region_altclkctrl_181_bjorw2i_sub  single_region_altclkctrl_181_bjorw2i_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
