...
mkdir -p ./libraries/single_region_altclkctrl_181/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altclkctrl_181/sim/single_region_altclkctrl_181_bjorw2i.v" -work single_region_altclkctrl_181 -cdslib ./cds_libs/single_region_altclkctrl_181.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/single_region.v"                                                                                                                                        
fi
