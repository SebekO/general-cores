def __helper():
  ...
  if syn_device[:7] == "10ax115": files.extend(["arria10gx_e3p1_pcie_hip/arria10gx_e3p1_pcie_hip.qsys"])
  if syn_device[:7] == "10ax027": files.extend(["arria10gx_scu4_pcie_hip/arria10gx_scu4_pcie_hip.qsys"])
