...
library IEEE;
library arria10gx_pcie_hip_altera_xcvr_fpll_a10_160;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;
use arria10gx_pcie_hip_altera_xcvr_fpll_a10_160.fpll_g1g2xn_pkg.all;

entity fpll_g1g2xn is
	generic (
		...
		cmu_fpll_silicon_rev                                                         : string  := "20nm4";
	...
	port (
		...
		pcie_sw               : in  std_logic_vector(1 downto 0)  := (others => '0'); --           pcie_sw.pcie_sw
		pcie_sw_done          : out std_logic_vector(1 downto 0);                     --      pcie_sw_done.pcie_sw_done
		mcgb_hip_cal_done     : out std_logic                                         -- mcgb_hip_cal_done.hip_cal_done
	);
end entity fpll_g1g2xn;

architecture rtl of fpll_g1g2xn is
begin
	...
	cmu_fpll_silicon_rev_check : if cmu_fpll_silicon_rev /= "20nm4" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cmu_fpll_pma_width_check : if cmu_fpll_pma_width /= 10 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	enable_mcgb_check : if enable_mcgb /= 1 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_pma_cgb_master_silicon_rev_check : if hssi_pma_cgb_master_silicon_rev /= "20nm4" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_pma_cgb_master_ser_mode_check : if hssi_pma_cgb_master_ser_mode /= "ten_bit" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_pma_cgb_master_input_select_check : if hssi_pma_cgb_master_input_select /= "lcpll_top" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	fpll_g1g2xn : component arria10gx_pcie_hip_altera_xcvr_fpll_a10_160.fpll_g1g2xn_pkg.altera_xcvr_fpll_a10
		generic map (
...
end architecture rtl; -- of fpll_g1g2xn
