...
library IEEE;
library arria10gx_pcie_hip_altera_xcvr_native_a10_160;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;
use arria10gx_pcie_hip_altera_xcvr_native_a10_160.phy_g1x4_pkg.all;

entity phy_g1x4 is
	generic (
		device_revision                                                        : string  := "20nm4";
		...
		adme_prot_mode                                                         : string  := "pipe_g1";
		adme_data_rate                                                         : string  := "2500000000";
		...
		hssi_gen3_rx_pcs_block_sync                                            : string  := "bypass_block_sync";
		hssi_gen3_rx_pcs_block_sync_sm                                         : string  := "disable_blk_sync_sm";
		hssi_gen3_rx_pcs_cdr_ctrl_force_unalgn                                 : string  := "disable";
		hssi_gen3_rx_pcs_lpbk_force                                            : string  := "lpbk_frce_dis";
		hssi_gen3_rx_pcs_mode                                                  : string  := "disable_pcs";
		hssi_gen3_rx_pcs_rate_match_fifo                                       : string  := "bypass_rm_fifo";
		hssi_gen3_rx_pcs_rate_match_fifo_latency                               : string  := "low_latency";
		hssi_gen3_rx_pcs_reverse_lpbk                                          : string  := "rev_lpbk_dis";
		hssi_gen3_rx_pcs_rx_b4gb_par_lpbk                                      : string  := "b4gb_par_lpbk_dis";
		hssi_gen3_rx_pcs_rx_force_balign                                       : string  := "dis_force_balign";
		hssi_gen3_rx_pcs_rx_ins_del_one_skip                                   : string  := "ins_del_one_skip_dis";
		hssi_gen3_rx_pcs_rx_num_fixed_pat                                      : integer := 0;
		hssi_gen3_rx_pcs_rx_test_out_sel                                       : string  := "rx_test_out0";
		hssi_gen3_rx_pcs_sup_mode                                              : string  := "user_mode";
		hssi_gen3_tx_pcs_mode                                                  : string  := "disable_pcs";
		hssi_gen3_tx_pcs_reverse_lpbk                                          : string  := "rev_lpbk_dis";
		...
		hssi_8g_rx_pcs_prot_mode                                               : string  := "pipe_g1";
		...
		hssi_8g_tx_pcs_gen3_tx_clk_sel                                         : string  := "dis_tx_clk";
		...
		hssi_8g_tx_pcs_prot_mode                                               : string  := "pipe_g1";
		...
		hssi_tx_pld_pcs_interface_hd_chnl_prot_mode_tx                         : string  := "pcie_g1_capable_tx";
		hssi_tx_pld_pcs_interface_hd_chnl_ctrl_plane_bonding_tx                : string  := "ctrl_master_tx";
		hssi_tx_pld_pcs_interface_hd_chnl_pma_dw_tx                            : string  := "pma_10b_tx";
		...
		hssi_tx_pld_pcs_interface_hd_chnl_pma_tx_clk_hz                        : integer := 250000000;
		...
		hssi_tx_pld_pcs_interface_hd_8g_prot_mode_tx                           : string  := "pipe_g1_tx";
		...
		hssi_tx_pld_pcs_interface_hd_g3_prot_mode                              : string  := "pipe_g1";
		...
		hssi_tx_pld_pcs_interface_hd_pmaif_prot_mode_tx                        : string  := "eightg_pcie_g12_hip_mode_tx";
		hssi_tx_pld_pcs_interface_hd_pmaif_pma_dw_tx                           : string  := "pma_10b_tx";
		...
		hssi_rx_pld_pcs_interface_hd_chnl_prot_mode_rx                         : string  := "pcie_g1_capable_rx";
		hssi_rx_pld_pcs_interface_hd_chnl_ctrl_plane_bonding_rx                : string  := "ctrl_master_rx";
		hssi_rx_pld_pcs_interface_hd_chnl_pma_dw_rx                            : string  := "pma_10b_rx";
		...
		hssi_rx_pld_pcs_interface_hd_chnl_pma_rx_clk_hz                        : integer := 250000000;
		...
		hssi_rx_pld_pcs_interface_hd_8g_prot_mode_rx                           : string  := "pipe_g1_rx";
		...
		hssi_rx_pld_pcs_interface_hd_g3_prot_mode                              : string  := "pipe_g1";
		...
		hssi_rx_pld_pcs_interface_hd_pmaif_prot_mode_rx                        : string  := "eightg_pcie_g12_hip_mode_rx";
		hssi_rx_pld_pcs_interface_hd_pmaif_pma_dw_rx                           : string  := "pma_10b_rx";
		...
		hssi_rx_pcs_pma_interface_pma_dw_rx                                    : string  := "pma_10b_rx";
		...
		hssi_rx_pcs_pma_interface_prot_mode_rx                                 : string  := "eightg_pcie_g12_hip_mode_rx";
		...
		hssi_tx_pcs_pma_interface_pcie_sub_prot_mode_tx                        : string  := "pipe_g12";
		hssi_tx_pcs_pma_interface_pldif_datawidth_mode                         : string  := "pldif_data_10bit";
		hssi_tx_pcs_pma_interface_pma_dw_tx                                    : string  := "pma_10b_tx";
		...
		hssi_tx_pcs_pma_interface_prot_mode_tx                                 : string  := "eightg_pcie_g12_hip_mode_tx";
		...
		hssi_tx_pcs_pma_interface_tx_pma_data_sel                              : string  := "eight_g_pcs";
		...
		hssi_common_pcs_pma_interface_prot_mode                                : string  := "pipe_g12";
		...
		pma_adapt_adp_1s_ctle_bypass                                           : string  := "radp_1s_ctle_bypass_1";
		pma_adapt_adp_4s_ctle_bypass                                           : string  := "radp_4s_ctle_bypass_1";
		...
		pma_adapt_adp_vref_bypass                                              : string  := "radp_vref_bypass_1";
		pma_adapt_adp_vref_en                                                  : string  := "radp_vref_disable";
		pma_adapt_datarate                                                     : string  := "2500000000 bps";
		pma_adapt_prot_mode                                                    : string  := "pcie_gen1_rx";
		...
		pma_adapt_adapt_mode                                                   : string  := "manual";
		...
		pma_cgb_datarate                                                       : string  := "2500000000 bps";
		pma_cgb_pcie_gen3_bitwidth                                             : string  := "pciegen3_wide";
		pma_cgb_prot_mode                                                      : string  := "pcie_gen1_tx";
		...
		pma_rx_dfe_datarate                                                    : string  := "2500000000 bps";
		...
		pma_rx_dfe_prot_mode                                                   : string  := "pcie_gen1_rx";
		pma_rx_odi_datarate                                                    : string  := "2500000000 bps";
		pma_rx_odi_sup_mode                                                    : string  := "user_mode";
		pma_rx_odi_step_ctrl_sel                                               : string  := "dprio_mode";
		pma_rx_odi_prot_mode                                                   : string  := "pcie_gen1_rx";
		pma_rx_buf_bypass_eqz_stages_234                                       : string  := "bypass_off";
		pma_rx_buf_datarate                                                    : string  := "2500000000 bps";
		pma_rx_buf_diag_lp_en                                                  : string  := "dlp_off";
		pma_rx_buf_prot_mode                                                   : string  := "pcie_gen1_rx";
		...
		pma_rx_buf_xrx_path_prot_mode                                          : string  := "pcie_gen1_rx";
		pma_rx_buf_xrx_path_datarate                                           : string  := "2500000000 bps";
		pma_rx_buf_xrx_path_datawidth                                          : integer := 10;
		pma_rx_buf_xrx_path_pma_rx_divclk_hz                                   : string  := "250000000";
		pma_rx_sd_prot_mode                                                    : string  := "pcie_gen1_rx";
		pma_rx_sd_sd_output_off                                                : integer := 5;
		...
		pma_tx_ser_prot_mode                                                   : string  := "pcie_gen1_tx";
		pma_tx_buf_datarate                                                    : string  := "2500000000 bps";
		pma_tx_buf_prot_mode                                                   : string  := "pcie_gen1_tx";
		...
		pma_tx_buf_xtx_path_prot_mode                                          : string  := "pcie_gen1_tx";
		pma_tx_buf_xtx_path_datarate                                           : string  := "2500000000 bps";
		pma_tx_buf_xtx_path_datawidth                                          : integer := 10;
		pma_tx_buf_xtx_path_clock_divider_ratio                                : integer := 1;
		pma_tx_buf_xtx_path_pma_tx_divclk_hz                                   : string  := "250000000";
		pma_tx_buf_xtx_path_tx_pll_clk_hz                                      : string  := "1250000000";
		...
		cdr_pll_datarate                                                       : string  := "2500000000 bps";
		cdr_pll_lpd_counter                                                    : integer := 8;
		cdr_pll_lpfd_counter                                                   : integer := 4;
		cdr_pll_n_counter_scratch                                              : integer := 1;
		cdr_pll_output_clock_frequency                                         : string  := "1250000000 Hz";
		...
		cdr_pll_vco_freq                                                       : string  := "10000000000 Hz";
		...
		cdr_pll_chgpmp_current_pfd                                             : string  := "cp_current_pfd_setting4";
		...
		cdr_pll_lf_resistor_pfd                                                : string  := "lf_pfd_setting2";
		...
		cdr_pll_m_counter                                                      : integer := 25;
		cdr_pll_n_counter                                                      : integer := 1;
		cdr_pll_pd_fastlock_mode                                               : string  := "false";
		cdr_pll_pd_l_counter                                                   : integer := 8;
		cdr_pll_pfd_l_counter                                                  : integer := 4;
		cdr_pll_primary_use                                                    : string  := "cdr";
		cdr_pll_prot_mode                                                      : string  := "pcie_gen1_rx";
		...
		cdr_pll_pcie_gen                                                       : string  := "pcie_gen1_100mhzref";
		...
		pma_rx_deser_datarate                                                  : string  := "2500000000 bps";
		...
		pma_rx_deser_prot_mode                                                 : string  := "pcie_gen1_rx";
		pma_rx_deser_pcie_gen                                                  : string  := "pcie_gen1_100mhzref";
...
architecture rtl of phy_g1x4 is
begin

	device_revision_check : if device_revision /= "20nm4" generate
	...
	adme_prot_mode_check : if adme_prot_mode /= "pipe_g1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	adme_data_rate_check : if adme_data_rate /= "2500000000" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_gen3_rx_pcs_block_sync_check : if hssi_gen3_rx_pcs_block_sync /= "bypass_block_sync" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_block_sync_sm_check : if hssi_gen3_rx_pcs_block_sync_sm /= "disable_blk_sync_sm" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_cdr_ctrl_force_unalgn_check : if hssi_gen3_rx_pcs_cdr_ctrl_force_unalgn /= "disable" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_lpbk_force_check : if hssi_gen3_rx_pcs_lpbk_force /= "lpbk_frce_dis" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_mode_check : if hssi_gen3_rx_pcs_mode /= "disable_pcs" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_rate_match_fifo_check : if hssi_gen3_rx_pcs_rate_match_fifo /= "bypass_rm_fifo" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_rate_match_fifo_latency_check : if hssi_gen3_rx_pcs_rate_match_fifo_latency /= "low_latency" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_reverse_lpbk_check : if hssi_gen3_rx_pcs_reverse_lpbk /= "rev_lpbk_dis" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_gen3_rx_pcs_rx_force_balign_check : if hssi_gen3_rx_pcs_rx_force_balign /= "dis_force_balign" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_rx_ins_del_one_skip_check : if hssi_gen3_rx_pcs_rx_ins_del_one_skip /= "ins_del_one_skip_dis" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_rx_pcs_rx_num_fixed_pat_check : if hssi_gen3_rx_pcs_rx_num_fixed_pat /= 0 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_gen3_tx_pcs_mode_check : if hssi_gen3_tx_pcs_mode /= "disable_pcs" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_gen3_tx_pcs_reverse_lpbk_check : if hssi_gen3_tx_pcs_reverse_lpbk /= "rev_lpbk_dis" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_gen3_tx_pcs_tx_gbox_byp_check : if hssi_gen3_tx_pcs_tx_gbox_byp /= "bypass_gbox" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_8g_rx_pcs_gen3_clk_en_check : if hssi_8g_rx_pcs_gen3_clk_en /= "disable_clk" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_8g_rx_pcs_prot_mode_check : if hssi_8g_rx_pcs_prot_mode /= "pipe_g1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_8g_tx_pcs_dynamic_clk_switch_check : if hssi_8g_tx_pcs_dynamic_clk_switch /= "dis_dyn_clk_switch" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_8g_tx_pcs_gen3_tx_clk_sel_check : if hssi_8g_tx_pcs_gen3_tx_clk_sel /= "dis_tx_clk" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_8g_tx_pcs_prot_mode_check : if hssi_8g_tx_pcs_prot_mode /= "pipe_g1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pld_pcs_interface_hd_chnl_prot_mode_tx_check : if hssi_tx_pld_pcs_interface_hd_chnl_prot_mode_tx /= "pcie_g1_capable_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pld_pcs_interface_hd_chnl_pma_dw_tx_check : if hssi_tx_pld_pcs_interface_hd_chnl_pma_dw_tx /= "pma_10b_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pld_pcs_interface_hd_chnl_pma_tx_clk_hz_check : if hssi_tx_pld_pcs_interface_hd_chnl_pma_tx_clk_hz /= 250000000 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pld_pcs_interface_hd_8g_prot_mode_tx_check : if hssi_tx_pld_pcs_interface_hd_8g_prot_mode_tx /= "pipe_g1_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pld_pcs_interface_hd_g3_prot_mode_check : if hssi_tx_pld_pcs_interface_hd_g3_prot_mode /= "pipe_g1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pld_pcs_interface_hd_pmaif_prot_mode_tx_check : if hssi_tx_pld_pcs_interface_hd_pmaif_prot_mode_tx /= "eightg_pcie_g12_hip_mode_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_tx_pld_pcs_interface_hd_pmaif_pma_dw_tx_check : if hssi_tx_pld_pcs_interface_hd_pmaif_pma_dw_tx /= "pma_10b_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_rx_pld_pcs_interface_hd_chnl_prot_mode_rx_check : if hssi_rx_pld_pcs_interface_hd_chnl_prot_mode_rx /= "pcie_g1_capable_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_rx_pld_pcs_interface_hd_chnl_pma_dw_rx_check : if hssi_rx_pld_pcs_interface_hd_chnl_pma_dw_rx /= "pma_10b_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_rx_pld_pcs_interface_hd_chnl_pma_rx_clk_hz_check : if hssi_rx_pld_pcs_interface_hd_chnl_pma_rx_clk_hz /= 250000000 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_rx_pld_pcs_interface_hd_8g_prot_mode_rx_check : if hssi_rx_pld_pcs_interface_hd_8g_prot_mode_rx /= "pipe_g1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_rx_pld_pcs_interface_hd_g3_prot_mode_check : if hssi_rx_pld_pcs_interface_hd_g3_prot_mode /= "pipe_g1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_rx_pld_pcs_interface_hd_pmaif_prot_mode_rx_check : if hssi_rx_pld_pcs_interface_hd_pmaif_prot_mode_rx /= "eightg_pcie_g12_hip_mode_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	hssi_rx_pld_pcs_interface_hd_pmaif_pma_dw_rx_check : if hssi_rx_pld_pcs_interface_hd_pmaif_pma_dw_rx /= "pma_10b_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_rx_pcs_pma_interface_pma_dw_rx_check : if hssi_rx_pcs_pma_interface_pma_dw_rx /= "pma_10b_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_rx_pcs_pma_interface_prot_mode_rx_check : if hssi_rx_pcs_pma_interface_prot_mode_rx /= "eightg_pcie_g12_hip_mode_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pcs_pma_interface_pcie_sub_prot_mode_tx_check : if hssi_tx_pcs_pma_interface_pcie_sub_prot_mode_tx /= "pipe_g12" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pcs_pma_interface_pma_dw_tx_check : if hssi_tx_pcs_pma_interface_pma_dw_tx /= "pma_10b_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pcs_pma_interface_prot_mode_tx_check : if hssi_tx_pcs_pma_interface_prot_mode_tx /= "eightg_pcie_g12_hip_mode_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_tx_pcs_pma_interface_tx_pma_data_sel_check : if hssi_tx_pcs_pma_interface_tx_pma_data_sel /= "eight_g_pcs" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_common_pcs_pma_interface_block_sel_check : if hssi_common_pcs_pma_interface_block_sel /= "eight_g_pcs" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_common_pcs_pma_interface_bypass_pma_sw_done_check : if hssi_common_pcs_pma_interface_bypass_pma_sw_done /= "false" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_common_pcs_pma_interface_ppm_deassert_early_check : if hssi_common_pcs_pma_interface_ppm_deassert_early /= "deassert_early_dis" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_common_pcs_pma_interface_prot_mode_check : if hssi_common_pcs_pma_interface_prot_mode /= "pipe_g12" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_pipe_gen3_mode_check : if hssi_pipe_gen3_mode /= "pipe_g1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_pipe_gen1_2_prot_mode_check : if hssi_pipe_gen1_2_prot_mode /= "pipe_g1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_adapt_adp_1s_ctle_bypass_check : if pma_adapt_adp_1s_ctle_bypass /= "radp_1s_ctle_bypass_1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_adapt_adp_4s_ctle_bypass_check : if pma_adapt_adp_4s_ctle_bypass /= "radp_4s_ctle_bypass_1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_adapt_adp_ctle_en_check : if pma_adapt_adp_ctle_en /= "radp_ctle_disable" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_adapt_adp_dfe_fxtap_hold_en_check : if pma_adapt_adp_dfe_fxtap_hold_en /= "radp_dfe_fxtap_not_held" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_adapt_adp_vga_en_check : if pma_adapt_adp_vga_en /= "radp_vga_disable" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_adapt_adp_vref_bypass_check : if pma_adapt_adp_vref_bypass /= "radp_vref_bypass_1" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_adapt_adp_vref_en_check : if pma_adapt_adp_vref_en /= "radp_vref_disable" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_adapt_datarate_check : if pma_adapt_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_adapt_prot_mode_check : if pma_adapt_prot_mode /= "pcie_gen1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_adapt_adapt_mode_check : if pma_adapt_adapt_mode /= "manual" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_cgb_datarate_check : if pma_cgb_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_cgb_prot_mode_check : if pma_cgb_prot_mode /= "pcie_gen1_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_dfe_datarate_check : if pma_rx_dfe_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_rx_dfe_dft_en_check : if pma_rx_dfe_dft_en /= "dft_disable" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_dfe_pdb_fixedtap_check : if pma_rx_dfe_pdb_fixedtap /= "fixtap_dfe_powerdown" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_dfe_prot_mode_check : if pma_rx_dfe_prot_mode /= "pcie_gen1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_rx_odi_datarate_check : if pma_rx_odi_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_odi_prot_mode_check : if pma_rx_odi_prot_mode /= "pcie_gen1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_buf_datarate_check : if pma_rx_buf_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_buf_prot_mode_check : if pma_rx_buf_prot_mode /= "pcie_gen1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_buf_xrx_path_prot_mode_check : if pma_rx_buf_xrx_path_prot_mode /= "pcie_gen1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_rx_buf_xrx_path_datarate_check : if pma_rx_buf_xrx_path_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_buf_xrx_path_pma_rx_divclk_hz_check : if pma_rx_buf_xrx_path_pma_rx_divclk_hz /= "250000000" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_rx_sd_prot_mode_check : if pma_rx_sd_prot_mode /= "pcie_gen1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_rx_sd_sd_output_off_check : if pma_rx_sd_sd_output_off /= 5 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_tx_ser_prot_mode_check : if pma_tx_ser_prot_mode /= "pcie_gen1_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_tx_buf_datarate_check : if pma_tx_buf_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_tx_buf_prot_mode_check : if pma_tx_buf_prot_mode /= "pcie_gen1_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_tx_buf_xtx_path_prot_mode_check : if pma_tx_buf_xtx_path_prot_mode /= "pcie_gen1_tx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_tx_buf_xtx_path_datarate_check : if pma_tx_buf_xtx_path_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_tx_buf_xtx_path_pma_tx_divclk_hz_check : if pma_tx_buf_xtx_path_pma_tx_divclk_hz /= "250000000" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_tx_buf_xtx_path_tx_pll_clk_hz_check : if pma_tx_buf_xtx_path_tx_pll_clk_hz /= "1250000000" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_datarate_check : if cdr_pll_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	cdr_pll_lpd_counter_check : if cdr_pll_lpd_counter /= 8 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	cdr_pll_lpfd_counter_check : if cdr_pll_lpfd_counter /= 4 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_output_clock_frequency_check : if cdr_pll_output_clock_frequency /= "1250000000 Hz" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_vco_freq_check : if cdr_pll_vco_freq /= "10000000000 Hz" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_chgpmp_current_pfd_check : if cdr_pll_chgpmp_current_pfd /= "cp_current_pfd_setting4" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_lf_resistor_pd_check : if cdr_pll_lf_resistor_pd /= "lf_pd_setting0" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	cdr_pll_lf_resistor_pfd_check : if cdr_pll_lf_resistor_pfd /= "lf_pfd_setting2" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_m_counter_check : if cdr_pll_m_counter /= 25 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_pd_l_counter_check : if cdr_pll_pd_l_counter /= 8 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	cdr_pll_pfd_l_counter_check : if cdr_pll_pfd_l_counter /= 4 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_prot_mode_check : if cdr_pll_prot_mode /= "pcie_gen1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	cdr_pll_pcie_gen_check : if cdr_pll_pcie_gen /= "pcie_gen1_100mhzref" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_deser_datarate_check : if pma_rx_deser_datarate /= "2500000000 bps" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	pma_rx_deser_prot_mode_check : if pma_rx_deser_prot_mode /= "pcie_gen1_rx" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	pma_rx_deser_pcie_gen_check : if pma_rx_deser_pcie_gen /= "pcie_gen1_100mhzref" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	phy_g1x4 : component arria10gx_pcie_hip_altera_xcvr_native_a10_160.phy_g1x4_pkg.arria10gx_pcie_hip_altera_xcvr_native_a10_160_hl7ikni
		generic map (
...
end architecture rtl; -- of phy_g1x4
