...
module lcpll_g3xn #(
		...
		parameter hssi_pma_lc_refclk_select_mux_silicon_rev                        = "20nm2",
		...
		parameter hssi_refclk_divider_silicon_rev                                  = "20nm2",
		parameter atx_pll_silicon_rev                                              = "20nm2",
		...
		parameter hssi_pma_cgb_master_silicon_rev                                  = "20nm2",
	...
	generate
		...
		if (hssi_pma_lc_refclk_select_mux_silicon_rev != "20nm2")
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (hssi_refclk_divider_silicon_rev != "20nm2")
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (hssi_pma_cgb_master_silicon_rev != "20nm2")
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
	...
	arria10gx_scu4_pcie_hip_altera_xcvr_atx_pll_a10_160_b5mha5y #(
		...
		.mcgb_aux_clk0           (mcgb_aux_clk0),                        //     mcgb_aux_clk0.tx_serial_clk
