...
module phy_g3x8 #(
		...
		parameter cdr_pll_set_cdr_vco_speed                                              = 3,
		...
		input  wire [15:0]   pipe_rate,             //             pipe_rate.pipe_rate
	...
	generate
		...
		if (cdr_pll_set_cdr_vco_speed != 3)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
	...
	arria10gx_scu4_pcie_hip_altera_xcvr_native_a10_160_7jjy4ei #(
